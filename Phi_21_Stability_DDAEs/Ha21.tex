...
\begin{rem}
Again, we notice that due to the numerical instabilities in computing the Kronecker-Weierstra\ss \ form \eqref{KW form}, we will not compute the spectrum $\si(E,A_0,\dots,A_m)$ based on \eqref{KW form}. 
...
Similarly, in order to apply these results for arbitrarily-high index system, first we transform system \eqref{free system} to the index-reduced form \eqref{impulse free system}.
...
\end{equation}
%
then both the MATLAB LMI-Toolbox or the package CVX work properly. The matrices $P$, $Q$ are
%
\begin{equation*}
P = \sm{-15.3413  &  2.2457  &  -2.6746 \\ 	8.5630 &  -4.1706  &   0.4629 \\  0.1705 &  -0.0140 & -0.8608}, \ 
Q = \sm{5.9597  & -1.1767  &  0.2239 \\ -1.1767  &   2.9958  &   0.3278 \\ 	0.2239 &   0.3278  &  0.3995} \ .
\end{equation*}
% 
\end{example}
