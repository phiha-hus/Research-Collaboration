...
To prove that $\bhA_d \geq 0$, we assume the contrary, i.e. there exist some indices $i$, $j$ with $[\bhA_d]_{ij}<0$. 
Then, for $e_j$, the jth unit vector, and for t > 0 small enough, we obtain which contradicts (3.5). Therefore, we conclude that ... .
